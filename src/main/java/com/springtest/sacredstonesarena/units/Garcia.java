...
public class Garcia extends Unit{
    private final static String name = "Garcia";
    private final static UnitClass unitClass = new Warrior();
    ...
    private final static int con = 16;
    private final static Weapon[] inventory = {new BraveAxe(), new SteelBow(), new Longbow()};
