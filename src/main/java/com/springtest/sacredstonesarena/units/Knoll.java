...
public class Knoll extends Unit{
    private final static String name = "Knoll";
    private final static UnitClass unitClass = new Summoner();
    private final static int maxHp = 45;
    private int currentHp;
    private final static int strength = 0;
    private final static int magic = 27;
    private final static int skill = 22;
    private final static int speed = 21;
    private final static int luck = 6;
    private final static int defense = 6;
    private final static int resistance = 26;
    private final static int con = 8;
    private final static Weapon[] inventory = {new Gleipnir(), new Luna(), new Flux()};
