...
public class Seth extends Unit{
    private final static String name = "Seth";
    private final static UnitClass unitClass = new Paladin();
    private final static int maxHp = 47;
    ...
    private final static Weapon[] inventory = {new SilverLance(), new SilverSword(), new Dragonspear()};
