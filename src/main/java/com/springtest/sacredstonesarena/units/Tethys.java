...
public class Tethys extends Unit{
    private final static String name = "Tethys";
    private final static UnitClass unitClass = new Dancer();
    private final static int maxHp = 34;
    private int currentHp;
    private final static int strength = 1;
    private final static int magic = 0;
    private final static int skill = 3;
    ...
    private final static Weapon[] inventory = {new IronSword(), new SlimSword(), new LightBrand()};
