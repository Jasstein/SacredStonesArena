...
public class Gilliam extends Unit{
    private final static String name = "Gilliam";
    ...
    private final static int luck = 13;
    private final static int defense = 30;
    private final static int resistance = 13;
    private final static int con = 16;
    private final static Weapon[] inventory = {new BraveLance(), new HandAxe(), new SteelBlade()};
