...
public class Valter extends Unit{
    private final static String name = "Valter";
    private final static UnitClass unitClass = new WyvernKnight();
    ...
    private final static int luck = 4;
    private final static int defense = 14;
    private final static int resistance = 13;
    private final static int con = 11;
    private final static Weapon[] inventory = {new KillerLance(), new SteelLance(), new ToxinLance()};
