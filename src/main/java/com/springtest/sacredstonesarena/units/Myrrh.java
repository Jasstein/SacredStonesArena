...
public class Myrrh extends Unit{
    private final static String name = "Myrrh";
    private final static UnitClass unitClass = new Manakete();
    ...
    private final static int speed = 17;
    private final static int luck = 8;
    private final static int defense = 20;
    private final static int resistance = 12;
    private final static int con = 5;
    private final static Weapon[] inventory = {new Dragonstone(), new Dragonstone(), new Dragonstone()};
