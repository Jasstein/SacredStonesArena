...
public class Syrene extends Unit{
    private final static String name = "Syrene";
    private final static UnitClass unitClass = new FalconKnight();
    ...
    private final static int speed = 26;
    private final static int luck = 17;
    private final static int defense = 13;
    private final static int resistance = 21;
    private final static int con = 7;
    private final static Weapon[] inventory = {new SilverSword(), new HeavySpear(), new ShortSpear()};
