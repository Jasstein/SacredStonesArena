...
public class Joshua extends Unit{
    private final static String name = "Joshua";
    private final static UnitClass unitClass = new Swordmaster();
    private final static int maxHp = 56;
    ...
    private final static Weapon[] inventory = {new Audhulma(), new KillingEdge(), new Armorslayer()};
