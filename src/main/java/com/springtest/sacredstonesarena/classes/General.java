...
public class General extends UnitClass {
    private final static String className = "General";
    private final static String weapon1 = "Sword";
    private final static String weapon2 = "Lance";
    private final static String weapon3 = "Axw";
    private final static String weakness = "Armor";
    private final static String physicalOrMagical = "Physical";
    private final static String skill = "Great Shield";
